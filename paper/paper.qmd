...
# Create a mapping of full day names to their abbreviations
...
# Group and filter data for each vehicle type, then abbreviate day names
...
# Create the plot with abbreviated day labels
